                            ...
                            <div class="col-lg-12 col-md-12">
                              <div class="card">
                                <div class="card-body rounded">
                                  <form class="">
                                    <div
                                      class="form-row mx-auto container-fluid justify-content-around align-content-center align-self-center mt-3"
                                    >
                                      <div
                                        class="form-group col-md-3 d-lg-flex d-block"
                                      >
                                        <label
                                          class="mr-2 mt-2 font-size-"
                        ...
                        <div class="card-body">
                          <div class="container-fluid">
                            <div class="border rounded position-relative">
                              <h1
                                class="m-t-20-minus mb-5 bg-white w-25 text-center ml-5 font-weight-bold"
                              >
                                Transaction
                              </h1>
                              <!-- content 1 -->
                          ...
                          <div class="mt-5">
                            ...
                            <div class="container-fluid">
                              <div class="border rounded position-relativer">
                                ...
                                >
                                  <h1 class="font-weight-bold">Revenue</h1>
                                </div>
