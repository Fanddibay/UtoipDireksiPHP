                              ...
                              <div class="card">
                                <div class="card-body rounded">
                                  <form class="">
                                    ...
                                    >
                                      <div
                                        class="form-group d-lg-flex col-md-3"
                                      >
                                        <label
                                          class="mr-2 mt-1 font-size-16"
                        ...
                        >
                          ...
                          <div class="p-2 flex-shrink-1 bd-highlight">
                            <div class="d-flex">
                              ...
                              <button
                                type="submit"
                                class="btn btn-primary m-l-r-5 text-center fc-center"
                              >
                              ...
                              <button
                                type="button"
                                class="btn btn-warning m-l-r-5 text-center fc-center"
                              >
                        ...
                        <div class="card-body">
                          <div class="container-fluid">
                            <div class="position-relative">
                              <div class="row overflow-hidden px-5">
                                        ...
                                        <div class="card-body">
                                          ...
                                          <div class="d-flex m-t-10-minus">
                                            ...
                                            >
                                              ...
                                              >
                                                <p
                                                  class="text-black-50 d-inline-flex font-size-14"
                                                >
                                                  <i
                          ...
                          <div class="mt-5">
                            <div class="container-fluid">
                              <div class="border rounded position-relativer">
                                <div
                                  class="m-t-20-minus mb-5 bg-white w-25 text-center ml-5"
                                >
                                  <h1 class="font-weight-bold">
                                    RS Productive Component
                                  </h1>
                                </div>
                                <div class="row overflow-hidden px-5">
                                  <div class="col-md-12">
                          ...
                          <div class="form-group d-flex mt-5">
                            <label
                              for="selectArea "
                              class="mr-2 font-size-16 mt-1"
                              >Component</label
                            >
                            <select class="form-control w-25" id="selectArea">
                              <option>TOTAL RS REGISTER</option>
                              <option>RS REGISTER ACTIVE</option>
                              <option>RS PJP ACTIVE</option>
                              <option>RS PRODUCTIVE OVERALL</option>
                              <option>RS PRODUCTIVE SA</option>
                              <option>RS PRODUCTIVE SO BARCODE</option>
                              <option>RS PRODUCTIVE RENEWAL ACQUISITION</option>
                              <option>RS PRODUCTIVE CVM</option>
                              <option>RS PRODUCTIVE VOICE</option>
                              <option>RS PRODUCTIVE GAMES</option>
                              <option>RS PRODUCTIVE USIM MIGRATION</option>
                              <option>RS PRODUCTIVE ORBIT PACKAGE</option>
                              <option>RS PRODUCTIVE ORBIT DEVICE</option>
                              <option>RS PRODUCTIVE OMNI</option>
                            </select>
                          </div>
                          <div class="card">
                            <div class="card-body rounded">
                              <h2 class="my-4 font-weight-bold">Daily Trend</h2>
                              <!-- chart -->
                              <div class="my-4">
                                <canvas
                                  id="myChart"
                              ...
                              <table class="table-2">
                                <tr>
                                  ...
                                  <th class="table-total-average">AVG DAILY</th>
                                </tr>
                                <tr>
