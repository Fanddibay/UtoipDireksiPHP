...
<html lang="en">
  ...
  <!-- light mode -->
  <body id="body" class="light small-navigation">
    <!-- begin::preloader-->
    <div class="preloader">
                        ...
                        <div class="card-body rounded">
                                  ...
                                  <div class="row px-5">
                                    ...
                                    <div class="col-lg col-md-12">
                                      <div class="card text-body">
                                        <div class="card-body rounded bg-cream">
                                          <div class="mb-4">
                                            <div>
                                              <h4
                                                class="text-center font-weight-bold"
                                          ...
                                          <div class="d-flex m-t-10-minus">
                                            ...
                                            >
                                              ...
                                              >
                                                ...
                                                >
                                                  <i
                                                    class="ti-arrow-up text-success mt-1 mr-2 text-body"
                                                  ></i>
                                                  -4.2%
                                                </p>
                                                <p
                          ...
                          <div class="form-group d-flex mt-5">
                            ...
                            <select class="form-control w-25" id="selectArea">
                              <option>All Parameter</option>
                              <option>Parameter 1</option>
                              <option>Parameter 2</option>
                              <option>Parameter 3</option>
                              <option>Parameter 4</option>
                            </select>
                          </div>
                          <div class="card">
                            <div class="card-body rounded">
                              <h2 class="font-weight-bold">Daily Trend</h2>
                              <!-- grafik -->
                              <div class="my-4">
                                <canvas
                                  id="myChart"
